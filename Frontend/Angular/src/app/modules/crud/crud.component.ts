  ...
  renderActionColumn(): void {
    const actionColumn = {
      ...
      render: (data: any, type: any, full: any) => {
        const editButton = `
          <button class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" data-action="edit" data-id="${full.RowID}">
            <i class="ki-duotone ki-pencil fs-3 color_edit"><span class="path1"></span><span class="path2"></span></i>
          </button>`;

        const deleteButton = `
          <button class="btn btn-icon btn-active-light-danger w-30px h-30px" data-action="delete" data-id="${full.RowID}">
            <i class="ki-duotone ki-trash fs-3 color_delete">
