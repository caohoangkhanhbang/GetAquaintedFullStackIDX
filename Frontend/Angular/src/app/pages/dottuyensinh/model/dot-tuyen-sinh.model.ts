...
export class DotTuyenSinhModel extends BaseModel {
    ...
    TenDotTS?: string | null;
    KhoaHoc?: string | null;
    ThoiGianNhanHSTuNgay?: string | null;
    ThoiGianNhanHSDenNgay?: string | null;
    NgayInGBTT?: Date | string | null;
    ThoiGianLayHSTuNgay?: string | null;
    ThoiGianLayHSDenNgay?: string | null;
    NgayNhapHocDK?: Date | string | null;
    GhiChu?: string | null;
    NguoiTao?: string | null;
    NgayTao?: Date | string | null;
    ...
    clear() {
        ...
        this.TenDotTS = '';
        this.KhoaHoc = '';
        this.ThoiGianNhanHSTuNgay = '';
        let date = new Date();
        date.setDate(date.getDate() + 7);
        this.ThoiGianNhanHSDenNgay = '';;
        this.NgayInGBTT = new Date();
        this.ThoiGianLayHSTuNgay = '';
        this.ThoiGianLayHSDenNgay = '';
        this.NgayNhapHocDK = new Date();
        this.GhiChu = '';
        this.NguoiTao = '';
        this.NgayTao = new Date();
