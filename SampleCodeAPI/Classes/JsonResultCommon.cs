...
namespace SampleCodeAPI.Classes
{
    public class JsonResultCommon
    {
        ...
        public static BaseModel<object> ThanhCong(object data, bool Visible)
        {
            return new BaseModel<object>
            {
                status = 1,
        ...
        public static BaseModel<object> ThatBai_ForceRun(string message)
        {
            return new BaseModel<object>()
            {
                status = 0,
        ...
        public static BaseModel<object> KhongCoQuyen()
        {
            return new BaseModel<object>()
            {
                status = -1,
        ...
        public static BaseModel<object> Exception(Exception last_error, IConfiguration _configuration, long custemerid, ControllerContext ControllerContext = null)
        {
            ...
            if (last_error != null && last_error.Data != null)
            {
                ...
                if (string.IsNullOrEmpty(custemerid.ToString()))
                {
                }
            }
            return new BaseModel<object>()
